  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-blue-200 flex-shrink-0 px-8 py-6 md:w-[450px] bg-white shadow-md"
            key={item.name}
          >
            <blockquote>
              <div
              ...
              <div className="relative z-20 mt-6 flex flex-col items-center">
                <span className="text-sm leading-[1.6] text-blue-600 font-semibold">
                  {item.name}
                </span>
